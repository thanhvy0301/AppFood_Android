...
import com.example.doanngocthanhvy_19dh110622.Restaurant;
import com.example.doanngocthanhvy_19dh110622.RestaurantAdapter;
 ...
 */
//implements RestaurantAdapter.OnRestaurantItemClickListener
public class RestaurantFragment extends Fragment implements RestaurantAdapter.OnRestaurantItemClickListener {
    ...
    public void onRestaurantItemClick(Restaurant restaurant) {
        ...
        //Toast.makeText( getContext(),restaurant.resKey, Toast.LENGTH_SHORT).show();
    }
