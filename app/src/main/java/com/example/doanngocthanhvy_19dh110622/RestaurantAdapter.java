...
//    public RestaurantAdapter(ArrayList<Restaurant> restaurants, int i) {
//
//    }
    ...
    public static class ViewHolderTopRestaurant extends RecyclerView.ViewHolder {
